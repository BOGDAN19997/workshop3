...
def dashboard():
    ...
    # SELECT
    #     ormUser.full_name,
    #     count(ormcreateDocByTemplate.patch_file) Document_count

    # FROM ormUser LEFT OUTER JOIN ormcreateDocByTemplate
    #   ON  ormUser.email = ormcreateDocByTemplate.email
    ...
    #     count(ormcreateDocByTemplate.email) user_count

    # FROM ormDocument LEFT OUTER JOIN ormcreateDocByTemplate
    #   ON  ormDocument.patch_file = ormcreateDocByTemplate.patch_file
